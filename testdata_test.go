...
var (
	testKeyRsaPrivate *rsa.PrivateKey
	testKeyRsaPublic  *rsa.PublicKey
)

const (
	testKeyRsaPssName      = "test-key-rsa-pss"
	testKeyRsaPssPublicPem = `-----BEGIN RSA PUBLIC KEY-----
...
2wIDAQAB
-----END RSA PUBLIC KEY-----`
	testKeyRsaPssPrivatePem = `-----BEGIN RSA PRIVATE KEY-----
...
var (
	testKeyRsaPssPrivate *rsa.PrivateKey
	testKeyRsaPssPublic  *rsa.PublicKey
)

const (
	testKeyEccP256Name      = "test-key-ecc-p256"
